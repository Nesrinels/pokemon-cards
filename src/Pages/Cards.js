...
import { Link, useParams, useLocation, Navigate } from 'react-router-dom'; // Use Navigate instead of Redirect
...
const Cards = () => {
  ...
  if (!img) return <Navigate to="/error404" />; // Use Navigate for redirection
